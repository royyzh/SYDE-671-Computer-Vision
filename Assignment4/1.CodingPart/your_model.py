...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # Conv2D(64, 3, 1, padding="same", activation="relu", name="block2_conv3"),
        ...
        # Conv2D(128, 3, 1, padding="same", activation="relu", name="block6_conv1"),
        # Conv2D(512, 3, 1, padding="same", activation="relu", name="block6_conv2"),
        # MaxPool2D(2, name="block6_pool"),
        # Dropout(0.2),
